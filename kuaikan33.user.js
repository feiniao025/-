...
// @author       Cube
// @version      1.0.1
// @description  Added skip start/end button for Dplayer
// @updateURL    https://cdn.jsdelivr.net/gh/miseli/cCDN/kuaikan33.user.js
// @require      https://cdn.staticfile.org/jquery/3.6.0/jquery.min.js
// @match        *://*/*
// @run-at       document-start
// @license      MIT
// @webRequest   {"selector":{"include":"*://*DPlayer*js", "exclude": "*://purge.jsdelivr.net/*"},"action":{"redirect":"https://cdn.jsdelivr.net/gh/miseli/cCDN/DPlayer.min.js"}}
// ==/UserScript==
...
$$(function () {
    ...
    const addscript = function (func_text) {
        // eslint-disable-next-line no-undef
        const s = unsafeWindow.document.createElement('script')
        s.text = func_text
        // eslint-disable-next-line no-undef
